...
const initialAnnouncements: Announcement[] = [
  {
    ...
    content: 'با سلام و احترام، کمپین انتخاباتی حزب مردم ایران برای انتخابات شورای شهر به طور رسمی آغاز شد. از همه هواداران و داوطلبان دعوت می‌کنیم تا در این مسیر با ما همراه باشند.',
    author: 'ستاد مرکزی',
